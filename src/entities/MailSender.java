...
public class MailSender {
     public static void sendMail(String mail) throws Exception {
        String mailContent = "<!DOCTYPE html>\n"
                ...
                + "		style=\"mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: red;\" width=\"100%\">\n"
                + "		<tbody>\n"
                + "			<tr>\n"
                + "				<td>\n"
                ...
                + "																							\n"
                + "																							A NOTRE BOUTIQUE</span></span></strong></span>\n"
                + "																		</p>\n"
                + "																		<p\n"
                ...
                + "																			<span\n"
                + "																				style=\"font-size:18px;color:#000000;\">Merci\n"
                + "																				pour votre achat</span></p>\n"
                + "																		<p\n"
                + "																			style=\"margin: 0; font-size: 14px; text-align: center;\">\n"
                + "																			<span\n"
                + "																				style=\"font-size:18px;color:#000000;\"></span></p>\n"
                + "																		<p\n"
                + "																			style=\"margin: 0; font-size: 14px; text-align: center;\">\n"
                + "																			<span\n"
                + "																				style=\"font-size:18px;color:#000000;\"><br>\n"
                + "																				"+"<br>Date d'achat : "+Date.valueOf(LocalDate.now())+"<br> </span></p>\n"
                + "																		<p\n"
                + "																			style=\"margin: 0; font-size: 14px; text-align: center;\">\n"
                + "																			<span\n"
                + "																				style=\"font-size:18px;color:#000000;\"><br></span>\n"
                + "																		</p>\n"
                + "																		<p\n"
                + "																			style=\"margin: 0; font-size: 14px; text-align: center;\">\n"
                + "																			<span\n"
    ...
    private static Message prepareMessage(Session session, String myAccountEmail, String recipient , String mailContent) {
        try {
            ...
            message.setSubject("Bienvenue sur notre boutique vente trotinette");
